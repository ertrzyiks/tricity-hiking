---
title: Dolina Strzyży (Valley of Strzyża stream)
...
tricity: true
preview: ./dolina-strzyzy.jpg
---

## Starting point

The route starts at the entrance to the _Dolina Strzyży_ (Strzyża Valley). You can get there by car and park
at a free parking lot along the _Potokowa_ street. You can also take a _PKM_ train from _Gdańsk Wrzeszcz_ to
_Gdańsk Brętowo_ station. You can reach the starting point by walking about 10 minutes from there. The same train
station can be approached by bus _227_. The closest you can get by bus is _Karskiego_ stop of _116_ bus.

> **Note:** Please verify current bus and train schedules at [ZTM Gdańsk](https://www.ztm.gda.pl/) before your trip.

## Along the stream

Once you enter the forest you will find yourself walking along the _Strzyża_ stream. The beginning of the trail is
quite flat. Once you reach the crossroad, take the second right, an uphill path. Eventually you will merge back
to the main trail so look for the first left turn, which will take you to the stream again. Continue straight and
you will reach the place where you can cross the stream. The construction that allows to pass on the other side
...
follow that path or pick one of the parallel trails. Soon enough you will reach quite wide, comfortable path.
...
or the stop enjoy sight of the retention tanks and meanders of the Strzyża stream.
