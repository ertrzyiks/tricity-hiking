...
description: Sopot
tricity: true
preview: ./sopot-wyscigi-to-kamienny-potok.jpg
---

import ArticleImage from "../../../components/ui/ArticleImage.astro";
import hippodrome from "../../../assets/photos/hipodrom.jpg";
import parkowaStreet from "../../../assets/photos/parkowa-budynek.jpg";
import uzdrowiskoSopot from "../../../assets/photos/sopot-uzdrowisko.jpg";
...
<ArticleImage
  src={hippodrome}
  caption="View on Hippodrome from Polna street"
  alt="Photo of Sopot Hippodrome"
/>
...
the center of Sopot avoiding the crowded promenade.

<ArticleImage
  src={parkowaStreet}
  caption="Characteristic building at Parkowa street"
  alt="Photo of Building at Parkowa street"
/>

The end of the street meets the South Park. It's a small
...
<ArticleImage
  src={uzdrowiskoSopot}
  caption="Balneological Institute in Sopot"
  alt="Photo of Balneological Institute in Sopot"
/>
