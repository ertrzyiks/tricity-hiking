...
description: Punkt widokowy w Rumii
preview: ../../assets/routes/gora-markowca.jpg
---

# Starting point

The route starts on the parking on the Młyńska street in Rumia. The most convenient way
...
This tail leads back to the crossroad. Before you reach it you will walk next to the historical Auerhahn glade.
