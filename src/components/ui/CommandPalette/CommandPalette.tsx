...
// Prototype for issue #5 (command-palette-nav): the header's only nav is
// this trigger + the Cmd/Ctrl+K shortcut — see
// .scratch/new-ui-prototypes/issues/05-command-palette-nav.md for the spec.
...
const CommandPalette = () => {
  ...
  // Cmd/Ctrl+K toggles the palette from anywhere on the page — the reason
  // this component is mounted once, globally, in Layout.astro rather than
  // scoped to the header search bar.
  useEffect(() => {
